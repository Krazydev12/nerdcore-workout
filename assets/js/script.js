...
$("#form").submit(function (event) {
    ...
    $.ajax(settings).then(function (response) {
        ...
        //     console.log(response.hits)
            // gets the first object in array of hits
            ...
            function findRecipes() {
                ...
                // let tRow = $("<tr>");
                let resultRecipe = response.hits;
                let first = document.querySelector("#recipe1").append(resultRecipe[0].recipe.url)
                let second = document.querySelector("#recipe2").append(resultRecipe[1].recipe.url)
                let third = document.querySelector("#recipe3").append(resultRecipe[2].recipe.url)
                let fourth = document.querySelector("#recipe4").append(resultRecipe[3].recipe.url)
                let fifth = document.querySelector("#recipe5").append(resultRecipe[4].recipe.url)
